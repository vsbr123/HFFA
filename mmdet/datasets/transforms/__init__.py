...
from .colorspace import (AutoContrast, Brightness, Color, ColorTransform,
                         ...
                         Solarize, SolarizeAdd, DefectColorRandomTransfer)
...
from .transformer_test import Retinex
# from .formatting_test import (Collect, D)
...
__all__ = [
    ...
    'Retinex', 'DefectColorRandomTransfer'
]
